...
<div class="row">
    <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-info">
            <div class="inner">
                <h3><?php echo mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM kategoribuku")); ?></h3>
                <p>Total Kategori</p>
            </div>
            <div class="icon">
    ...
    <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-warning">
            <div class="inner">
                <h3><?php echo mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM ulasanbuku")); ?></h3>
                <p>Total Ulasan</p>
            </div>
            <div class="icon">
...
<div class="card">
    <div class="card-body">
        <table class="table table-bordered">
            <?php
            $query = mysqli_query($koneksi, "SELECT * FROM user where UserID=" . $_SESSION['user']['UserID']);
